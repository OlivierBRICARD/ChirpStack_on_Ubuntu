...
sudo -u postgres psql -c "create role chirpstack_as with login password 'chirpstack';"
sudo -u postgres psql -c "create role chirpstack_ns with login password 'chirpstack';"
